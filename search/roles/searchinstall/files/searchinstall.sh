...
sudo yum -y install java-1.8.0-openjdk.x86_64      #Installing Java 8

sudo wget https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-5.2.1.rpm

sudo rpm --install elasticsearch-5.2.1.rpm
...
##Install Kibana##
sudo wget https://artifacts.elastic.co/downloads/kibana/kibana-5.2.1-x86_64.rpm

sudo rpm --install kibana-5.2.1-x86_64.rpm
